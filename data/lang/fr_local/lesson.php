...
$string['completionendreached_desc'] = 'Si ce réglage est activé, l’étudiant doit atteindre la page de fin de la séquence pour achever cette activité';
...
$string['dependencyon_help'] = 'Grâce à ce réglage, l’accès à cette séquence peut dépendre des résultats de l’étudiant à d’autres séquences dans le même cours. Il est possible de combiner les critères « durée utilisée », « terminé » ou « note plus haute que ».';
$string['displayleftif_help'] = 'Ce réglage détermine si un étudiant doit obtenir une note minimale pour que le menu de la séquence soit affiché. Ceci impose à l’étudiant de parcourir la totalité de la séquence lors de sa première tentative, puis lui permet d’utiliser le menu pour sa relecture, s’il a obtenu la note requise.';
...
$string['handlingofretakes_help'] = 'Lorsque les étudiants ont la permission de répéter la séquence, ce réglage spécifie si la note de la séquence est la moyenne ou la note de la meilleure tentative.';
$string['indicator:cognitivedepth'] = 'Séquence : aspect cognitif';
$string['indicator:cognitivedepth_help'] = 'Cet indicateur est basé sur la profondeur cognitive atteinte par l’étudiant dans une activité Séquence.';
...
$string['indicator:socialbreadth_help'] = 'Cet indicateur se base sur l’interaction sociale atteinte par l’étudiant dans une activité Séquence.';
...
$string['maximumnumberofattempts_help'] = 'Ce réglage fixe le nombre maximal de tentatives à disposition des étudiants pour répondre à chaque question. Si une réponse incorrecte est répétée, lorsque cette valeur est atteinte, la page suivante de la séquence est affichée.';
...
$string['modattempts_help'] = 'Si ce réglage est activé, les étudiants peuvent reprendre la séquence depuis le début.';
...
$string['privacy:metadata:overrides:available'] = 'La date et l’heure à laquelle les étudiants peuvent commencer la séquence.';
...
$string['retakesallowed_help'] = 'Si ce réglage est activé, les étudiants peuvent effectuer la séquence à plusieurs reprises.';
...
$string['teacherjumpwarning'] = 'Un saut {$a->cluster} ou un saut {$a->unseen} est utilisé dans cette séquence. Un saut « Page suivante » sera utilisé à sa place. Veuillez vous connecter en tant qu’étudiant pour tester ces sauts.';
...
$string['usersnone'] = 'Aucun étudiant n’a accès à cette séquence';
$string['youhaveseen'] = 'Vous avez déjà vu au moins une page de cette séquence.<br />Voulez-vous commencer à la dernière page que vous avez vue ?';